...
export const CardCv = () => {
  ...
  return (
    <div>
       <div class="relative duration-500  hover:-rotate-0   group [transform:rotate3d(1_,-1,_1,_60deg)] border border-sky-700 border-4  overflow-hidden rounded-2xl relative h-96 w-64 bg-[#3C5CFF]  p-5 flex flex-col items-start gap-4">
